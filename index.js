...
By : ${chalk.blue('@ERICONTOLL')} - ${chalk.blue('https://t.me/ERIC_HACK')}

Features :

1. ${chalk.cyan('Reward : 1 Crown + 30 Trophy + 35 Star ( Stumble Pass ) + 3000 EXP')}
2. ${chalk.cyan('Reward : 20 Trophy + 30 Star ( Stumble Pass ) + 1500 EXP')}
3. ${chalk.cyan('Reward : 10 Trophy + 25 Star ( Stumble Pass ) + 500 EXP')}
4. ${chalk.cyan('Reward : 20 Star ( Stumble Pass ) + 100 EXP')}
`);
    ...
    if (feature == '1') {
        ...
        while (true) {
            ...
            if (!result) {
                ...
                console.log(chalk.bgBlack(`[ ${moment().format('HH:mm')} ] ${chalk.cyan(`${username}`)} | ${chalk.blue(`${exp}`)} | ${chalk.blue(`${tokenPass}`)} | ${chalk.yellow(`${trophy}`)} | ${chalk.yellow(`${crown}`)} | ${chalk.yellow(`${country}`)} |`));
                await delay(time)
